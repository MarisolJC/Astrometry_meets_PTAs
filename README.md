...
* You will find a notebook to plot the forecasts for the magnitude of the SGWB energy density with the results in section 3.1 of the paper mentioned in :file_folder: **Forecast**.
