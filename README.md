...
* You will find a notebook in :file_folder: **Forecast** to plot the forecasts for the magnitude of the SGWB energy density with the results in section 3.1 of the paper mentioned.
