...
![Screenshot of a comment on a GitHub issue showing an image, added in the Markdown, of an Octocat smiling and raising a tentacle.]([/main](https://github.com/MarisolJC/Astrometry_Maps/pta_astro_MAPS/K1K1_dipole_Random.png)
